...
| [`docs/CANONICAL_REPO_GUIDE.md`](docs/CANONICAL_REPO_GUIDE.md) | New-reader guide: where to start, what is canonical, what is supplementary |
| [`docs/PUBLIC_RELEASE_CHECKLIST.md`](docs/PUBLIC_RELEASE_CHECKLIST.md) | Pre-release hygiene record and maintainer verification checklist |
...
See [`FINAL_MANUSCRIPT_ASSET_INDEX.md`](FINAL_MANUSCRIPT_ASSET_INDEX.md) for the
full authoritative inventory of canonical manuscript assets.

| Path | Contents | Status |
|------|----------|--------|
| `outputs/paper_tables_final/` | **Canonical** manuscript table CSVs (regenerated by `scripts/generate_final_manuscript_artifacts.py`) | ✅ Main paper |
| `outputs/paper_figures_final/` | **Canonical** manuscript figures + graphic abstract | ✅ Main paper |
| `outputs/budget_sweep/` | Budget-vs-accuracy sweep CSVs | ✅ Main paper |
| `outputs/real_*_policy_eval/` | Per-regime policy evaluation JSON + CSV | ✅ Main paper |
| `outputs/oracle_routing_eval/` | Oracle routing upper-bound analysis | ✅ Main paper |
| `outputs/cross_regime_comparison/` | Cross-regime summary | ✅ Main paper |
| `outputs/baselines/` | Baseline strategy comparison JSON | ✅ Main paper |
| `outputs/paper_tables_cleaned/` | Historical intermediate tables (superseded by `paper_tables_final/`) | 📦 Historical |
| `outputs/paper_figures_cleaned/` | Historical intermediate figures (superseded by `paper_figures_final/`) | 📦 Historical |
